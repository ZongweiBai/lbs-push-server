...
public class GTPushController {
    ...
    @RequestMapping(value = {"/bindAlias"}, method = {RequestMethod.POST})
    @ResponseBody
    ...
    @RequestMapping(value = {"/pushTransmissionMessageToPerson"}, method = {RequestMethod.POST})
    @ResponseBody
    ...
    @RequestMapping(value = {"/pushTransmissionMessageToMultiPerson"}, method = {RequestMethod.POST})
    @ResponseBody
    public void pushTransmissionMessageToMultiPerson(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            ResponseDataHandler.dealList(locationBeans, response);
        } catch (Exception e) {
            e.printStackTrace();
